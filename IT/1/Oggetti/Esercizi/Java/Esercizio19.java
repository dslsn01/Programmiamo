...
class Mechanic {
	public void checkup(Vehicle v) {
		System.out.println(v + " -> [TAGLIANDO ESEGUITO]");
	}
}
...
public class Esercizio19 {
	public static void main(String [] args) {
		...
		mechanic.checkup(fiat500);
		mechanic.checkup(classeA);
		mechanic.checkup(alfaGiulia);

		mechanic.checkup(truck);
		mechanic.checkup(tractor);
	}
}
